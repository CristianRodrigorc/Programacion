...
public class Ej2 {
	...
	public static void findNum(ArrayList list) {
		...
		int positionNum = list.indexOf(findNum); //Buscamos el ídice del número
	...
	public static void subMenuInset (ArrayList list) {
		System.out.println("Presione \"1\" para insertar un número y reemplazarlo en la posición indicada");
		System.out.println("Presione \"2\" para insertar un número y desplazar una posición los siguientes números");
...
//	//Metodo que remplaza el número en la posición indicada
	public static void insetNum1 (ArrayList list) {
		...
		list.set(position, newNum);
		
		System.out.println("La nueva Lista de número es: ");
		printArrayNum(list);
...
//	para insertar el número indicado
	public static void insetNum2 (ArrayList list) {
		boolean condition = false;
		do {
