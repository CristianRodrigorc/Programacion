...
public class cajeroMain {
		...
		do {
			...
			if(!temp.isEmpty()){
				...
				case 'D':
					...
					sc.nextLine();
					transferSaldo(users, positionTemp, idDestinatario, montoTransferencia);
					break;
	...
	public static void transferSaldo (ArrayList<Cliente> users, int positionTemp,int idDestinatario, double montoTransferencia) {
		...
		retireSaldo(users, positionTemp, montoTransferencia);
		depositSaldo(users, idDestinatario , montoTransferencia);
